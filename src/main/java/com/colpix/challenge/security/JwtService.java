...
/**
 * Servicio para la gestión de tokens JWT (generación, validación y extracción de datos).
 */
@Service
public class JwtService {
    ...
    /**
     * Extrae todos los claims del token usando el parser moderno.
     */
    ...
    /**
     * Obtiene la clave de firma a partir del secreto configurado (Base64).
     */
